              ...
              <table>
                  ...
                  <tr>
                      ...
                      <td style="text-align: left;">
                          <button id="submitModify_btn">确认修改</button>
                          <button onclick="location.href='http://39.107.125.189:8080/cas/logout?service=http://39.107.125.189:8080/cas'">退出登录</button>
                      </td>
                  </tr>
              </table>
          </div>
